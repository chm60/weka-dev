...
public abstract class PairedTester implements OptionHandler, Tester, RevisionHandler {
    ...
    protected class Resultset implements RevisionHandler, Serializable {
        ...
        public Resultset(Instance template) {
            ...
            m_Template = template;
            m_Datasets = new ArrayList<PairedTester.Dataset>();
            add(template);
        }
        ...
        public void add(Instance newInst) {
            ...
            PairedTester.Dataset newDataset = new PairedTester.Dataset(newInst);
    ...
    protected void prepareData() throws Exception {
        ...
        for (int i = 0; i < m_Instances.numInstances(); i++) {
            ...
            for (int j = 0; j < m_Resultsets.size(); j++) {
                PairedTester.Resultset resultset = m_Resultsets.get(j);
            ...
            if (!found) {
                PairedTester.Resultset resultset = new PairedTester.Resultset(current);
    ...
    /**
     * Gets current settings of the PairedTester.
     *
